...
A product-feature backlog organized by release window. This is the *product* view; the operational/infrastructure planning backlog (privacy, CI/CD, legal, payments) lives in [../../notion-docs/PLANNING_BACKLOG.md](../../notion-docs/PLANNING_BACKLOG.md) and is referenced by item number (e.g. backlog #43). Sequencing is in [ROADMAP.md](./ROADMAP.md); requirements in [PRODUCT_REQUIREMENTS_DOCUMENT.md](./PRODUCT_REQUIREMENTS_DOCUMENT.md).
...
| SRS forgiveness layer (cap + soft catch-up + streak freeze + no guilt) | Must | Blocker — design open (backlog #43). |
...
| Apple + Google IAP | Must | `expo-in-app-purchases`. |
...
- Operational/infra backlog: [../../notion-docs/PLANNING_BACKLOG.md](../../notion-docs/PLANNING_BACKLOG.md)
- Tier pricing and competitive rationale: [../../notion-docs/PRODUCT_STRATEGY.md](../../notion-docs/PRODUCT_STRATEGY.md)
