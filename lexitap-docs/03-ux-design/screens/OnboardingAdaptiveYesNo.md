...
| **Pseudo-words** | Seed 2–3 plausible non-words mid-sequence, presented identically (NOT visually flagged). A confident Yes on a pseudo-word = false alarm. Apply signal-detection correction: 0 FA → none; 1/3 → modest discount; 2–3/3 → strong discount, cap estimate low. Pseudo-words never count toward "known" total. |
