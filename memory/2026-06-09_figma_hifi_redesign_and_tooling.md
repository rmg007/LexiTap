...
**Home reframe task (#3) — VERIFIED DONE, no edit (2026-06-09):** Task "Home 09 reframe: Frequency Band 2 → Top 3,000 · 1,240/3,000" was **already complete** on canonical Polished Home `156:2` (Hi-Fi). Card reads `Keep learning / Top 3,000 / 1,240 / 3,000 words learned / 41%` (nodes `157:6`/`157:7`/`157:10`) — screenshot-verified. **File-wide search: zero frames contain "Frequency Band 2"** (only "Band" hit = legit IELTS band-score copy in PU-1 pack screen). Did NOT fabricate a redundant edit. **Residual cleaned:** original `63:2177` "09 · Home (Hi-Fi)" was a wrong-app mock (Spanish · Intermediate · Unit 4 Travel + Flashcards/Speaking/Pronunciation — contradicts LexiTap's English-only, no-speaking, frequency-list model) → **Ryan chose delete** (superseded by 156:2). Hi-Fi page 76→75.

**Diagnostic + KMap copy task (#4) — DONE (2026-06-09):** Task "tie '~3,200 known' to the 3k list." The reveal number was numerically incoherent — **~3,200 "known" can't sit "of the Top 3,000"** (exceeds the list), and the headline sub-label "words in English" floated free of any list. Fix = put the sample learner **inside** the entry list so the number ties cleanly: KMap `207:8` `~3,200`→`~2,400`, `207:9` `words in English`→`of the Top 3,000 words`, `207:22` card rewritten to "most of the Top 3,000 — your free starting list… around word 2,400, not back at word 1. The Top 9,000 opens up as you go." Diagnostic `206:11` subtitle `Finding your place in the Top 9,000…`→`Finding your place in the Top 3,000 — your free starting list. Be honest; it tunes the list.` Both screenshot-verified; the KMap Known/Learning/New bar (~80% green) now visually agrees with 2,400/3,000=80%. Sample word still `vibrant`. **Cross-screen note (not fixed, out of scope):** KMap "already know" = pre-existing vocab from the diagnostic; Home "1,240/3,000 learned" = SRS reps logged in-app — different metrics, both now framed against the Top 3,000 list, but a future pass may want one shared label to avoid the "you know 2,400 but home starts you at 1,240" optics.
