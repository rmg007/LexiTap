...
- **"Review your work" / "review your code" / "check your work" / "review and fix" → invoke `/review-and-fix` immediately.** Run the full 7-angle review, verify every surviving candidate, then fix every CONFIRMED and PLAUSIBLE finding before reporting. Never return a findings list and stop — always fix. The command lives at [`.claude/commands/review-and-fix.md`](.claude/commands/review-and-fix.md).
