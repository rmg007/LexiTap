...
- App skeleton ~85% (clean/hexagonal, ~120 TS files). **Content: Foundation ~2,848/3,000 sourced** (2,881 words / 2,894 memberships; TOEFL + exam tiers still stubs) — enrichment is the real launch blocker.
...
- **1.4 Rebuild `words.db`.** ✅ `content_tiers` (9) + `word_tiers` (2,894 memberships / 2,881 unique words) match config; copied to `mobile/assets/vocab/words.db`.
