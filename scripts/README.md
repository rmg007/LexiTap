...
- **Start at [`.design-specs/FIGMA.md`](../.design-specs/FIGMA.md)** — the canonical map of the design file: file key (`8YT6PYWnpX6nqkT2mxXOwi`), page IDs, component inventory, the binding gate, and the SECTION/Archive gotchas. A cold-start agent reads this before touching any screen.
